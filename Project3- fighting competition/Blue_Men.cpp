...
int Blue_Men::attack()
{
    ...
    cout << "Blue Men attack with a roll of " << rollTotal << endl;
...
void Blue_Men::defense(int inputAttack, bool inputMedusa)
{
    ...
    if (inputAttack == 12 && inputMedusa == true)
    {
        ...
        cout << endl;
        cout << "Blue Men have been killed by Medusa's glare!";
        cout << endl << endl;
    }
    else
    {
        ...
        cout << "Blue Men defend with " << armor << " armor";
        cout << " and " << strength << " strength before the attack" << endl;
        cout << "Blue Men defend with a roll of " << rollTotal << endl;
        ...
        cout << "Blue Men have " << strength << " strength after the attack";
        cout << endl;

        if (strength <= 0)
        {
            cout << endl;
            cout << "The Blue Men have died!";
        }
    }
}